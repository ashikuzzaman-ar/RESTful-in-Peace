...
public class PatientController extends BeanProvider {
     ...
     * @return
     */
    @RequestMapping(value = "patient/get", method = RequestMethod.GET)
        ...
        try {
            ...
            if (userToken != null && token.equals(userToken)) {
                ...
                if (from > 0L && to > 0L) {
                    ...
                    json = this.getMapper().writeValueAsString(patientProvider.getPatients(from, to, this));
                } else {
